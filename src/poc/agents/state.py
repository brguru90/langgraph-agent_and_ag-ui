...
class StepModal(BaseModel):
    ...
    weight_of_current_response: Optional[float] = Field(..., description="The weight of the current response will be updated manually by the agent, LLM don't need to process it")
